...
function (vcpkg_configure AUTO_VCPKG_BOOTSTRAP_SKIP)
	...
	# Modified to also look existing toolchain file directory (which is supplied as an argument to CMAKE by MSVC)
	# e.g. C:/Programming/lib/vcpkg/scripts/buildsystems/vcpkg.cmake"

	list(APPEND VCPKG_SEARCH_PATH ${AUTO_VCPKG_ROOT})
	if(CMAKE_TOOLCHAIN_FILE)
		get_filename_component(VCPKG_TOOLCHAIN_PATH ${CMAKE_TOOLCHAIN_FILE} DIRECTORY)
		list(APPEND VCPKG_SEARCH_PATH ${VCPKG_TOOLCHAIN_PATH})
		list(APPEND VCPKG_SEARCH_PATH "${VCPKG_TOOLCHAIN_PATH}/../")
		list(APPEND VCPKG_SEARCH_PATH "${VCPKG_TOOLCHAIN_PATH}/../../")
		list(APPEND VCPKG_SEARCH_PATH "${VCPKG_TOOLCHAIN_PATH}/../../../")
	endif()

	list(APPEND VCPKG_SEARCH_PATH ${CMAKE_CURRENT_LIST_DIR})
	
	message(STATUS "AutoVcpkg: searching for vcpkg in ${VCPKG_SEARCH_PATH}")
    find_program(AUTO_VCPKG_EXECUTABLE
            vcpkg vcpkg.exe PATHS ${VCPKG_SEARCH_PATH})
    if (NOT AUTO_VCPKG_EXECUTABLE)
