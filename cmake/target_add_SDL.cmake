...
if(ENABLE_SDL2)
	find_install_package(PACKAGE_NAME "SDL2" POSSIBLE_TARGETS "SDL2::SDL2")
endif()
if(ENABLE_SDL2_MIXER)
	find_install_package(PACKAGE_NAME "sdl2-mixer" VCPKG_NAME "sdl2-mixer" POSSIBLE_TARGETS "SDL2::SDL2_mixer")
endif()
if(ENABLE_SDL2_IMAGE)
	find_install_package(PACKAGE_NAME "sdl2-image" VCPKG_NAME "sdl2-image" POSSIBLE_TARGETS "SDL2::SDL2_image")
endif()

function(target_include_sdl2 target)
	if(ENABLE_SDL2)
		target_include_lib(TARGET ${target} PACKAGE_NAME "SDL2")
	endif()
	if(ENABLE_SDL2_MIXER)
		target_include_lib(TARGET ${target} PACKAGE_NAME "sdl2-mixer")
	endif()
	if(ENABLE_SDL2_IMAGE)
		target_include_lib(TARGET ${target} PACKAGE_NAME "sdl2-image")
	endif()
endfunction()

function(target_link_sdl2 target)
	if(ENABLE_SDL2)
		target_link_deploy_lib(TARGET ${target} PACKAGE_NAME "SDL2")
	endif()
	if(ENABLE_SDL2_MIXER)
		target_link_deploy_lib(TARGET ${target} PACKAGE_NAME "sdl2-mixer")
	endif()	
	if(ENABLE_SDL2_IMAGE)
		target_link_deploy_lib(TARGET ${target} PACKAGE_NAME "sdl2-image")
	endif()
endfunction()