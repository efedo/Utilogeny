...
function(target_include_sdl2 target)
	...
	if(ENABLE_SDL2)
		...
		if(TARGET "SDL2::SDL2")
			message("SDL target already added.")
		endif()
	...
	if(ENABLE_SDL2_IMAGE)
		find_install_package(PACKAGE_NAME "SDL2_image" VCPKG_NAME "sdl2-image" REQUIRED_TARGETS "SDL2_image::SDL2_image" INCLUDES_NOT_REQUIRED)
...
function(target_link_sdl2 target)
	...
	if(ENABLE_SDL2_IMAGE)
		target_link_deploy_lib(LINK_TARGET ${target} PACKAGE_NAME "SDL2_image")
	endif()
endfunction()