	...
	foreach(REQUIRED_TARGET ${lib_target})
		if(NOT(TARGET ${REQUIRED_TARGET}))
			if(PARSED_ARGS_PACKAGE_NAME)
				...
				message(FATAL_ERROR "Could not find library target ${REQUIRED_TARGET}. Available targets are: ${BUILDSYSTEM_LINK_TARGETS}")
			endif()
		endif()
	endforeach()
...
function(target_link_deploy_lib)
	...
	foreach(REQUIRED_TARGET ${lib_target})
		...
		get_target_property(target_type ${REQUIRED_TARGET} TYPE)
		...
		#if (target_type MATCHES "DYNAMIC_LIBRARY")
			...
			")
		#else()
		#	message(STATUS "${REQUIRED_TARGET} is not dynamic library, skipping installation")
		#endif()
	endforeach()
endfunction()
