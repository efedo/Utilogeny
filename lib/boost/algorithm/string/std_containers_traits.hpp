...
#include "Utilogeny/lib/boost/algorithm/string/std/string_traits.hpp"
#include "Utilogeny/lib/boost/algorithm/string/std/list_traits.hpp"

#ifdef BOOST_HAS_SLIST
#   include "Utilogeny/lib/boost/algorithm/string/std/slist_traits.hpp"
#endif
