...
#include "Utilogeny/lib/boost/atomic/detail/core_operations_emulated.hpp"
...
#include BOOST_ATOMIC_DETAIL_CORE_ARCH_BACKEND_HEADER(Utilogeny/lib/boost/atomic/detail/core_arch_ops_)
#endif
