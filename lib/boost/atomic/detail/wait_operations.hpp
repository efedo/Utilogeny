...
#include "Utilogeny/lib/boost/atomic/detail/wait_ops_emulated.hpp"

#if !defined(BOOST_ATOMIC_DETAIL_WAIT_BACKEND_GENERIC)
#include BOOST_ATOMIC_DETAIL_WAIT_BACKEND_HEADER(Utilogeny/lib/boost/atomic/detail/wait_ops_)
#endif
