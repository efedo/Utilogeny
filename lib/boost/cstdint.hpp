...
//   12 Nov 00  Merged "Utilogeny/lib/boost/stdint.h" (Jens Maurer)
...
//
// Utilogeny/lib/boost/cstdint.hpp:428:35: error: use of C99 long long integer constant
//
...
# include "Utilogeny/lib/boost/limits.hpp" // implementation artifact; not part of interface
...
# else
#    error defaults not correct; you must hand modify Utilogeny/lib/boost/cstdint.hpp
# endif
