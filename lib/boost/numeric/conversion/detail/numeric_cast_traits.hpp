...
//
    ...
    #include "Utilogeny/lib/boost/numeric/conversion/detail/preprocessed/numeric_cast_traits_common.hpp"
	
	#if !defined(BOOST_NO_LONG_LONG)
        #include "Utilogeny/lib/boost/numeric/conversion/detail/preprocessed/numeric_cast_traits_long_long.hpp"
	#endif
	
#else
#if !BOOST_PP_IS_ITERATING

    #include "Utilogeny/lib/boost/preprocessor/seq/elem.hpp"
...
namespace boost { namespace numeric {
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_NUMERIC_CONVERSION_SEQ_A())), "Utilogeny/lib/boost/numeric/conversion/detail/numeric_cast_traits.hpp"))
...
namespace boost { namespace numeric {
    ...
    #define BOOST_PP_ITERATION_PARAMS_2 (3, (0, BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_NUMERIC_CONVERSION_SEQ_B())), "Utilogeny/lib/boost/numeric/conversion/detail/numeric_cast_traits.hpp"))
    #include BOOST_PP_ITERATE()
