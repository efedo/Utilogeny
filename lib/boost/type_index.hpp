...
/// \file Utilogeny/lib/boost/type_index.hpp
...
#   include "Utilogeny/lib/boost/type_index/stl_type_index.hpp"
#   if defined(BOOST_NO_RTTI) || defined(BOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)
#       include "Utilogeny/lib/boost/type_index/detail/stl_register_class.hpp"
#       ifdef BOOST_HAS_PRAGMA_DETECT_MISMATCH
...
#   endif
#else
#   include "Utilogeny/lib/boost/type_index/ctti_type_index.hpp"
#   include "Utilogeny/lib/boost/type_index/detail/ctti_register_class.hpp"
#   ifdef BOOST_HAS_PRAGMA_DETECT_MISMATCH
