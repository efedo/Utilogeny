...
public:
    ...
    void draw_sprite(int x, int y, Data::Resource res, unsigned int index, bool use_off);
    void draw_sprite(int x, int y, Data::Resource res, unsigned int index, bool use_off, float progress);
    void draw_sprite(int x, int y, Data::Resource res, unsigned int index, bool use_off, const Color &color);
    void draw_sprite_relatively(int x, int y, Data::Resource res, unsigned int index,
    Data::Resource relative_to_res, unsigned int relative_to_index);
    void draw_masked_sprite(int x, int y, Data::Resource mask_res, unsigned int mask_index, Data::Resource res, unsigned int index);
    void draw_waves_sprite(int x, int y, Data::Resource mask_res, unsigned int mask_index, Data::Resource res, unsigned int index);
    ...
    /* Text functions */
    void draw_string(int x, int y, const std::string &str, const Color &color, const Color &shadow = Color::transparent);
    void draw_number(int x, int y, int value, const Color &color, const Color &shadow = Color::transparent);

    /* Frame functions */
    void draw_frame(int dx, int dy, int sx, int sy, Frame *src, int w, int h);

protected:
    void draw_char_sprite(int x, int y, unsigned char c, const Color &color, const Color &shadow);
