...
public:
	VideoSDL();
	virtual ~VideoSDL();
	virtual void set_resolution(unsigned int width, unsigned int height, bool fullscreen);
	...
	virtual Video::Image *create_image(void *data, unsigned int width, unsigned int height);
	virtual void destroy_image(Video::Image *image);
	virtual void warp_mouse(int x, int y);
	virtual void draw_image(const Video::Image *image, int x, int y, int y_offset, Video::Frame *dest);
	virtual void draw_frame(int dx, int dy, Video::Frame *dest, int sx, int sy, Video::Frame *src, int w, int h);
	virtual void draw_rect(int x, int y, unsigned int width, unsigned int height, const Video::Color color, Video::Frame *dest);
	virtual void fill_rect(int x, int y, unsigned int width, unsigned int height, const Video::Color color, Video::Frame *dest);
	virtual void draw_line(int x, int y, int x1, int y1, const Video::Color color, Video::Frame *dest);
