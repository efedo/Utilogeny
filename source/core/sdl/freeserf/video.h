...
public:
    ...
    virtual void set_resolution(unsigned int width, unsigned int height, bool fullscreen) = 0;
    ...
    virtual Image *create_image(void *data, unsigned int width, unsigned int height) = 0;
    virtual void destroy_image(Image *image) = 0;
    virtual void warp_mouse(int x, int y) = 0;
    virtual void draw_image(const Image *image, int x, int y, int y_offset, Frame *dest) = 0;
    virtual void draw_frame(int dx, int dy, Frame *dest, int sx, int sy, Frame *src, int w, int h) = 0;
    virtual void draw_rect(int x, int y, unsigned int width, unsigned int height, const Video::Color color, Frame *dest) = 0;
    virtual void fill_rect(int x, int y, unsigned int width, unsigned int height, const Video::Color color, Frame *dest) = 0;
    virtual void draw_line(int x, int y, int x1, int y1, const Video::Color color, Frame *dest) = 0;
